...
var recipeAppetizer1 = new Recipe(
    1, 1, 'Strawberry Goat Cheese Bruschetta', 'http://images.media-allrecipes.com/userphotos/600x600/1039162.jpg', '25 min', 0, 0, 'admin@cookbook.hu', new Date(),
...
var recipeAppetizer2 = new Recipe(
    2, 1, 'Bacon Wrapped Smokies', 'http://images.media-allrecipes.com/userphotos/600x600/581356.jpg', '90 min', 0, 0, 'admin@cookbook.hu', new Date(),
...
var recipeChicken1 = new Recipe(
    3, 2, 'Baked Garlic Parmesan Chicken', 'http://images.media-allrecipes.com/userphotos/600x600/618489.jpg', '45 min', 0, 0, 'admin@cookbook.hu', new Date(),
...
var recipeChicken2 = new Recipe(
    4, 2, 'Salsa Chicken', 'http://images.media-allrecipes.com/userphotos/600x600/3294655.jpg', '45 min', 0, 0, 'admin@cookbook.hu', new Date(),
...
var recipeDessert1 = new Recipe(
    5, 3, 'Apple Pie', 'http://images.media-allrecipes.com/userphotos/600x600/736203.jpg', '90 min', 0, 0, 'admin@cookbook.hu', new Date(),
...
var recipeDessert2 = new Recipe(
    6, 3, 'Chocolate Applesauce Cake', 'http://images.media-allrecipes.com/userphotos/600x600/563692.jpg', '55 min', 0, 0, 'admin@cookbook.hu', new Date(),
...
var recipePasta1 = new Recipe(
    7, 4, 'Sausage Pasta', 'http://images.media-allrecipes.com/userphotos/600x600/1814168.jpg', '45 min', 0, 0, 'admin@cookbook.hu', new Date(),
...
var recipePasta2 = new Recipe(
    8, 4, 'Mediterranean Pasta', 'http://images.media-allrecipes.com/userphotos/600x600/683300.jpg', '40 min', 0, 0, 'admin@cookbook.hu', new Date(),
...
var recipePork1 = new Recipe(
    9, 5, 'Baked Pork Chops', 'http://images.media-allrecipes.com/userphotos/600x600/3453298.jpg', '120 min', 0, 0, 'admin@cookbook.hu', new Date(),
...
var recipePork2 = new Recipe(
    10, 5, 'Caramel Apple Pork Chops', 'http://images.media-allrecipes.com/userphotos/600x600/971671.jpg', '45 min', 0, 0, 'admin@cookbook.hu', new Date(),
...
var recipeSalad1 = new Recipe(
    11, 6, 'Avocado Salad', 'http://images.media-allrecipes.com/userphotos/600x600/256657.jpg', '10 min', 0, 0, 'admin@cookbook.hu', new Date(),
...
var recipeSalad2 = new Recipe(
    12, 6, 'Spring Salad', 'http://images.media-allrecipes.com/userphotos/600x600/461429.jpg', '25 min', 0, 0, 'admin@cookbook.hu', new Date(),
